...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/mysterious75/voracode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for mysterious75/voracode...\n")
...
console.log("Fetching npm all-time downloads for voracode-ai...\n")
const npmDownloads = await fetchNpmDownloads("voracode-ai")
