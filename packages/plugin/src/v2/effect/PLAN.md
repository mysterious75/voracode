...
- Effect plugins import `@voracode-ai/plugin/v2/effect`, not `@voracode-ai/core`.
- Public domain values use generated `@voracode-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@voracode-ai/plugin/v2/effect`.
