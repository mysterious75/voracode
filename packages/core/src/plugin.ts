...
import type { Plugin as PluginRuntime } from "@voracode-ai/plugin/v2/effect"
...
export class Service extends Context.Service<Service, Interface>()("@voracode/v2/Plugin") {}
