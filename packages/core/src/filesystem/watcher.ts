...
import { FileSystemWatcher } from "@voracode-ai/schema/filesystem-watcher"
...
declare const VORACODE_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof VORACODE_LIBC === "undefined" ? undefined : VORACODE_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@voracode/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.VORACODE_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.VORACODE_EXPERIMENTAL_FILEWATCHER)) {
