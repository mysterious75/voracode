...
import { Event } from "@voracode-ai/schema/project-directories"
import { ProjectCopy } from "@voracode-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@voracode/ProjectCopy") {}
