...
import type { EffectDrizzleSqlite } from "@voracode-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@voracode/ProjectDirectories") {}
