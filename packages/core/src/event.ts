...
import type { Data, Definition, Payload } from "@voracode-ai/schema/event"
...
import { Durable } from "@voracode-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@voracode-ai/schema/event").ID
export type { Data, Definition, Payload } from "@voracode-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@voracode/Event") {}
