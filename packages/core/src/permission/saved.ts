...
import { PermissionSaved } from "@voracode-ai/schema/permission-saved"
...
export class Service extends Context.Service<Service, Interface>()("@voracode/v2/PermissionSaved") {}
