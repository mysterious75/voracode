...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@voracode-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@voracode/v2/ToolRegistry") {}
