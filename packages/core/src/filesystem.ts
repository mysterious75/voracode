...
import { Entry, FileSystem, FindInput, Match } from "@voracode-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@voracode-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@voracode/v2/FileSystem") {}
