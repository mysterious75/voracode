import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@voracode-ai/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
