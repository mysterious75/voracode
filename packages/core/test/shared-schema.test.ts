...
import { AgentAttachment, FileAttachment, Prompt, Source } from "@voracode-ai/schema/prompt"
import { Provider } from "@voracode-ai/schema/provider"
import { Project } from "@voracode-ai/schema/project"
import { ProjectDirectories } from "@voracode-ai/schema/project-directories"
import { PermissionV1 } from "@voracode-ai/schema/permission-v1"
...
import { Command } from "@voracode-ai/schema/command"
import { Connection } from "@voracode-ai/schema/connection"
import { Credential } from "@voracode-ai/schema/credential"
import { FileSystem } from "@voracode-ai/schema/filesystem"
import { Integration } from "@voracode-ai/schema/integration"
import { LLM } from "@voracode-ai/schema/llm"
import { Permission } from "@voracode-ai/schema/permission"
import { Plugin } from "@voracode-ai/schema/plugin"
import { Pty } from "@voracode-ai/schema/pty"
import { Reference } from "@voracode-ai/schema/reference"
import { SessionTodo } from "@voracode-ai/schema/session-todo"
import { Skill } from "@voracode-ai/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@voracode-ai/schema/schema"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@voracode-ai/core/command"),
    import("@voracode-ai/core/integration/connection"),
    import("@voracode-ai/core/credential"),
    import("@voracode-ai/core/filesystem"),
    import("@voracode-ai/core/integration"),
    import("@voracode-ai/core/location"),
    import("@voracode-ai/llm"),
    import("@voracode-ai/core/permission"),
    import("@voracode-ai/core/v1/permission"),
    import("@voracode-ai/core/project/copy"),
    import("@voracode-ai/core/pty"),
    import("@voracode-ai/core/project/schema"),
    import("@voracode-ai/core/reference"),
    import("@voracode-ai/core/session/input"),
    import("@voracode-ai/core/session/message"),
    import("@voracode-ai/core/session/todo"),
    import("@voracode-ai/core/session/prompt"),
    import("@voracode-ai/core/skill"),
    import("@voracode-ai/core/v2-schema"),
    import("@voracode-ai/core/schema"),
    import("@voracode-ai/core/workspace"),
  ])
