...
import type { AssistantMessage, FilePart, UserMessage } from "@voracode-ai/sdk/v2"
...
import { VORACODE_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, usevoracodeKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.VORACODE_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
