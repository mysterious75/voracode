...
import { useBindings, usevoracodeModeStack } from "../keymap"
...
function init() {
  ...
  const renderer = useRenderer()
  const modeStack = usevoracodeModeStack()
  ...
  return (
    <ctx.Provider value={value}>
      ...
      <box
        ...
        onMouseUp={!Flag.VORACODE_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? copySelection : undefined}
      >
