...
import defaultSoundPath from "@voracode-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@voracode-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@voracode-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@voracode-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@voracode-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@voracode-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "voracode"
const DEFAULT_PACK_ID = "voracode.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "Voracode Default",
  builtin: true,
  sounds: {
