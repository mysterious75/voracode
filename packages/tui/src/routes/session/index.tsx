...
import { VORACODE_BASE_MODE, useBindings, useCommandShortcut, usevoracodeKeymap } from "../../keymap"
...
const GO_UPSELL_PROVIDERS = new Set(["voracode", "voracode-go"])
...
function WebSearch(props: ToolProps) {
  return (
    <InlineTool icon="o" pending="Searching web..." complete={stringValue(props.input.query)} part={props.part}>
...
function Task(props: ToolProps) {
  ...
  return (
    <InlineTool
      icon={props.part.state.status === "completed" ? "[x]" : "|"}
      separate={true}
...
function Execute(props: ToolProps) {
  ...
  return (
    <>
      <InlineTool
        icon={hasRuntimeError() ? "--" : props.part.state.status === "completed" ? "[x]" : "|"}
