...
export const TypeId: TypeId = "~@voracode-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@voracode-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@voracode-ai/effect-sqlite-node/NodeSqliteClient")
