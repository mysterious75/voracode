...
export const dict = {
  ...
  "notFound.title": "Non trovato | voracode",
  "notFound.heading": "404 - Pagina non trovata",
  "notFound.home": "Home",
  "notFound.docs": "Documentazione",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "logo chiaro di voracode",
  "notFound.logoDarkAlt": "logo scuro di voracode",
  ...
  "app.meta.description": "Voracode - L'agente di programmazione open source.",

  "home.title": "Voracode | L'agente di coding IA open source",

  "temp.title": "voracode | Agente di coding IA costruito per il terminale",
  ...
  "temp.feature.zen.afterLink": "fornita da voracode",
  "temp.feature.models.beforeLink": "Supporta 75+ provider LLM tramite",
  "temp.feature.models.afterLink": ", inclusi modelli locali",
  "temp.screenshot.caption": "Voracode TUI con il tema tokyonight",
  "temp.screenshot.alt": "Voracode TUI con tema tokyonight",
  "temp.logoLightAlt": "logo chiaro di voracode",
  "temp.logoDarkAlt": "logo scuro di voracode",
  ...
  "home.promo.cta": "Scarica lâ€™ultima versione per iniziare.",
  "home.promo.close": "Chiudi lâ€™annuncio dellâ€™app Desktop",
  ...
  "home.what.title": "Che cos'Ã¨ Voracode?",
  "home.what.body": "Voracode Ã¨ un agente open source che ti aiuta a scrivere codice nel terminale, IDE o desktop.",
  ...
  "home.growth.body":
    "Con oltre <strong>{{stars}}</strong> stelle su GitHub, <strong>{{contributors}}</strong> contributori e oltre <strong>{{commits}}</strong> commit, Voracode Ã¨ usato e apprezzato da oltre <strong>{{monthlyUsers}}</strong> sviluppatori ogni mese.",
  ...
  "home.privacy.body":
    "Voracode non archivia il tuo codice nÃ© i dati di contesto, cosÃ¬ puÃ² operare in ambienti sensibili alla privacy.",
  "home.privacy.learnMore": "Scopri di piÃ¹ su",
  "home.privacy.link": "privacy",

  "home.faq.q1": "Che cos'Ã¨ Voracode?",
  "home.faq.a1":
    "Voracode Ã¨ un agente open source che ti aiuta a scrivere ed eseguire codice con qualsiasi modello di IA. Ãˆ disponibile come interfaccia terminale, app desktop o estensione IDE.",
  "home.faq.q2": "Come uso Voracode?",
  "home.faq.a2.before": "Il modo piÃ¹ semplice per iniziare Ã¨ leggere l'",
  "home.faq.a2.link": "introduzione",
  "home.faq.q3": "Mi servono abbonamenti IA extra per usare Voracode?",
  "home.faq.a3.p1":
    "Non necessariamente: Voracode include un set di modelli gratuiti che puoi usare senza creare un account.",
  "home.faq.a3.p2.beforeZen": "Inoltre, puoi usare modelli popolari per il coding creando un account",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Anche se incoraggiamo gli utenti a usare Zen, Voracode funziona anche con i provider piÃ¹ diffusi come OpenAI, Anthropic, xAI, ecc.",
  "home.faq.a3.p4.beforeLocal": "Puoi anche collegare i tuoi",
  "home.faq.a3.p4.localLink": "modelli locali",
  "home.faq.q4": "Posso usare i miei abbonamenti IA esistenti con Voracode?",
  "home.faq.a4.p1":
    "SÃ¬, Voracode supporta gli abbonamenti dei principali provider. Puoi usare Claude Pro/Max, ChatGPT Plus/Pro o GitHub Copilot.",
  "home.faq.q5": "Posso usare Voracode solo nel terminale?",
  "home.faq.a5.beforeDesktop": "Non piÃ¹! Voracode ora Ã¨ disponibile come app per",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "e",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Quanto costa Voracode?",
  "home.faq.a6":
    "Voracode Ã¨ gratuito al 100%. Include anche un set di modelli gratuiti. Potrebbero esserci costi aggiuntivi se colleghi altri provider.",
  ...
  "home.faq.q8": "Voracode Ã¨ open source?",
  "home.faq.a8.p1": "SÃ¬, Voracode Ã¨ completamente open source. Il codice sorgente Ã¨ pubblico su",
  ...
  "home.zenCta.body":
    "Zen ti dÃ  accesso a una selezione di modelli di IA che Voracode ha testato e benchmarkato specificamente per agenti di coding. Niente piÃ¹ preoccupazioni per prestazioni e qualitÃ  incoerenti tra provider: usa modelli validati che funzionano.",
  "home.zenCta.link": "Scopri Zen",

  "zen.title": "Voracode Zen | Una selezione curata di modelli affidabili e ottimizzati per agenti di coding",
  "zen.hero.title": "Accedi a modelli affidabili e ottimizzati per agenti di coding",
  "zen.hero.body":
    "Zen ti dÃ  accesso a una selezione di modelli di IA che Voracode ha testato e benchmarkato specificamente per agenti di coding. Niente piÃ¹ preoccupazioni per prestazioni e qualitÃ  incoerenti tra provider: usa modelli validati che funzionano.",

  "zen.faq.q1": "Cos'Ã¨ Voracode Zen?",
  "zen.faq.a1":
    "Zen Ã¨ un set curato di modelli di IA testati e benchmarkati per agenti di coding, creato dal team dietro Voracode.",
  ...
  "zen.faq.a3":
    "Zen non Ã¨ a scopo di lucro. Zen ribalta i costi dei provider di modelli direttamente su di te. PiÃ¹ Zen viene usato, piÃ¹ Voracode puÃ² negoziare tariffe migliori e passarle a te.",
  ...
  "zen.faq.a4.p3":
    "Per coprire i costi, Voracode aggiunge solo una piccola commissione di elaborazione del pagamento di $1.23 per ogni ricarica di saldo da $20.",
  ...
  "zen.faq.a8":
    "Anche se Zen funziona alla grande con Voracode, puoi usare Zen con qualsiasi agente. Segui le istruzioni di configurazione nel tuo agente di coding preferito.",
  ...
  "zen.problem.subtitle": "Stiamo risolvendo questo problema per tutti, non solo per gli utenti Voracode.",
  ...
  "zen.how.body": "Anche se ti consigliamo di utilizzare Zen con Voracode, puoi utilizzare Zen con qualsiasi agente.",
  ...
  "go.title": "Voracode Go | Modelli di coding a basso costo per tutti",
  "go.meta.description":
  ...
  "go.problem.body":
    "Ci concentriamo nel portare l'esperienza Voracode a quante piÃ¹ persone possibile. Voracode Go Ã¨ un abbonamento a basso costo: $5 il primo mese, poi $10/mese. Offre limiti generosi e accesso affidabile ai modelli open source piÃ¹ capaci.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go inizia a $5 per il primo mese, poi $10/mese. Puoi usarlo con Voracode o qualsiasi agente.",
  ...
  "go.faq.q1": "Che cos'Ã¨ Voracode Go?",
  "go.faq.a1":
  ...
  "zen.api.error.trialEnded":
    "La promozione gratuita di {{model}} Ã¨ terminata. Puoi continuare a usare il modello abbonandoti a Voracode Go - {{link}}",

  "black.meta.title": "Voracode Black | Accedi ai migliori modelli di coding al mondo",
  "black.meta.description":
    "Ottieni l'accesso a Claude, GPT, Gemini e altri con i piani di abbonamento Voracode Black.",
  "black.hero.title": "Accedi ai migliori modelli di coding al mondo",
  "black.hero.subtitle": "Inclusi Claude, GPT, Gemini e altri",
  "black.title": "Voracode Black | Prezzi",
  ...
  "black.workspace.title": "Voracode Black | Seleziona Workspace",
  "black.workspace.selectPlan": "Seleziona un workspace per questo piano",
  "black.workspace.name": "Workspace {{n}}",
  "black.subscribe.title": "Abbonati a Voracode Black",
  ...
  "black.subscribe.success.title": "Sei nella lista d'attesa di Voracode Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Usa Zen con qualsiasi agente di coding, e continua a usare altri provider con voracode quando vuoi.",
  ...
  "workspace.newUser.step.login.after": "e seleziona voracode",
  "workspace.newUser.step.pasteKey": "Incolla la tua chiave API",
  "workspace.newUser.step.models.before": "Avvia voracode ed esegui",
  ...
  "workspace.keys.subtitle": "Gestisci le tue chiavi API per accedere ai servizi voracode.",
  "workspace.keys.create": "Crea Chiave API",
  "workspace.keys.placeholder": "Inserisci nome chiave",
  "workspace.keys.empty": "Crea una chiave API voracode Gateway",
  ...
  "workspace.black.subscription.message": "Sei abbonato a Voracode Black per ${{plan}} al mese.",
  ...
  "workspace.black.waitlist.joined": "Sei nella waitlist per il piano Voracode Black da ${{plan}} al mese.",
  "workspace.black.waitlist.ready": "Siamo pronti per iscriverti al piano Voracode Black da ${{plan}} al mese.",
  ...
  "workspace.lite.subscription.message": "Sei abbonato a Voracode Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Seleziona "Voracode Go" come provider nella tua configurazione voracode per utilizzare i modelli Go.',
  ...
  "workspace.lite.black.message":
    "Attualmente sei abbonato a Voracode Black o sei in lista d'attesa. Annulla l'iscrizione prima se desideri passare a Go.",
  "workspace.lite.other.message":
    "Un altro membro in questo workspace Ã¨ giÃ  abbonato a Voracode Go. Solo un membro per workspace puÃ² abbonarsi.",
  "workspace.lite.promo.description":
    "Voracode Go parte da {{price}}, poi $10/mese, e offre un accesso affidabile a popolari modelli di coding aperti con generosi limiti di utilizzo.",
  ...
  "download.meta.description": "Scarica Voracode per macOS, Windows e Linux",
  "download.hero.title": "Scarica Voracode Desktop",
  ...
  "download.faq.a3.beforeLocal":
    "Non necessariamente, ma probabilmente. Avrai bisogno di un abbonamento IA se vuoi collegare Voracode a un provider a pagamento, sebbene tu possa lavorare con",
  ...
  "download.faq.a3.afterZen": ", Voracode funziona con tutti i provider popolari come OpenAI, Anthropic, xAI ecc.",

  "download.faq.a5.p1": "Voracode Ã¨ gratuito al 100%.",
  "download.faq.a5.p2.beforeZen":
    "Eventuali costi aggiuntivi proverranno dal tuo abbonamento a un provider di modelli. Mentre Voracode funziona con qualsiasi provider di modelli, raccomandiamo di usare",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "I tuoi dati e informazioni sono archiviati solo quando crei link condivisibili in Voracode.",
  "download.faq.a6.p2.beforeShare": "Scopri di piÃ¹ sulle",
  "download.faq.a6.shareLink": "pagine condivise",

  "enterprise.title": "Voracode | Soluzioni Enterprise per la tua organizzazione",
  "enterprise.meta.description": "Contatta Voracode per soluzioni enterprise",
  "enterprise.hero.title": "Il tuo codice Ã¨ tuo",
  "enterprise.hero.body1":
    "Voracode opera in modo sicuro all'interno della tua organizzazione senza dati o contesto archiviati e senza restrizioni di licenza o rivendicazioni di proprietÃ . Inizia una prova con il tuo team, poi distribuisci attraverso la tua organizzazione integrandolo con il tuo SSO e gateway IA interno.",
  ...
  "enterprise.faq.q1": "Cos'Ã¨ Voracode Enterprise?",
  "enterprise.faq.a1":
    "Voracode Enterprise Ã¨ per le organizzazioni che vogliono garantire che il loro codice e dati non lascino mai la loro infrastruttura. PuÃ² farlo usando una configurazione centralizzata che si integra con il tuo SSO e gateway IA interno.",
  "enterprise.faq.q2": "Come inizio con Voracode Enterprise?",
  "enterprise.faq.a2":
    "Inizia semplicemente con una prova interna con il tuo team. Voracode per impostazione predefinita non archivia il tuo codice o dati di contesto, rendendo facile iniziare. Poi contattaci per discutere prezzi e opzioni di implementazione.",
  ...
  "enterprise.faq.q4": "I miei dati sono sicuri con Voracode Enterprise?",
  "enterprise.faq.a4":
    "SÃ¬. Voracode non archivia il tuo codice o dati di contesto. Tutto il trattamento avviene localmente o attraverso chiamate API dirette al tuo provider IA. Con configurazione centrale e integrazione SSO, i tuoi dati rimangono sicuri all'interno dell'infrastruttura della tua organizzazione.",

  "brand.title": "Voracode | Brand",
  "brand.meta.description": "Linee guida del brand Voracode",
  "brand.heading": "Linee guida del brand",
  "brand.subtitle": "Risorse e asset per aiutarti a lavorare con il brand Voracode.",
  "brand.downloadAll": "Scarica tutti gli asset",

  "changelog.title": "Voracode | Changelog",
  "changelog.meta.description": "Note di rilascio e changelog Voracode",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Nuovi aggiornamenti e miglioramenti a Voracode",
