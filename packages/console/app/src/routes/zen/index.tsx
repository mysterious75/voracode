...
import compareVideo from "../../asset/lander/voracode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/voracode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="voracode:auth" content={loggedin() ? "true" : "false"} />
