      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://voracode.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>voracode.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g voracode-ai")}>
                <code>
                  npm i -g <strong>voracode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g voracode-ai")}>
                <code>
                  bun add -g <strong>voracode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install mysterious75/tap/voracode")}>
                <code>
                  brew install <strong>mysterious75/tap/voracode</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S voracode")}>
                <code>
                  paru -S <strong>voracode</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask voracode-desktop")}>
                <code>
                  brew install --cask <strong>voracode-desktop</strong>
                </code>
                <CopyStatus />
              </button>
