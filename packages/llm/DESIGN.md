...
> current private `@voracode-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@voracode-ai/ai`
...
- Secondary audience: Voracode and other durable agent runtimes
...
import { LLM } from "@voracode-ai/ai"
import { OpenAI } from "@voracode-ai/ai/providers/openai"
...
```ts
import { Message } from "@voracode-ai/ai"
...
import { LLM, Tool } from "@voracode-ai/ai"
...
Voracode and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@voracode-ai/ai/promise"
import { OpenAI } from "@voracode-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@voracode-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@voracode-ai/ai/provider"
...
@voracode-ai/ai/promise
  Promise/AsyncIterable LLM facade

@voracode-ai/ai/schema
  serializable domain schemas

@voracode-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@voracode-ai/ai/providers/openai
@voracode-ai/ai/providers/anthropic
@voracode-ai/ai/providers/google
...
```
...
| Current                                 | Proposed                                                    |
| --------------------------------------- | ----------------------------------------------------------- |
| `@voracode-ai/llm`                      | `@voracode-ai/ai`                                           |
...
Voracode should migrate to `generateTurn` / `streamTurn`, preserving its durable
