...
Schema-first LLM core for voracode. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@voracode-ai/llm"
import { OpenAI } from "@voracode-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@voracode-ai/llm/providers"
