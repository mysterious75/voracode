...
export const dict = {
  ...
  "dialog.provider.voracode.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.voracode.tagline": "ZuverlÃ¤ssige, optimierte Modelle",
  "dialog.provider.voracodeGo.tagline": "KostengÃ¼nstiges Abo fÃ¼r alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Voracode",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-SchlÃ¼ssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Voracode zu nutzen.",
  ...
  "provider.connect.voracodeZen.line1":
    "Voracode Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlÃ¤ssiger, optimierter Modelle fÃ¼r Coding-Agenten.",
  ...
  "provider.connect.voracodeZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.voracodeZen.visit.link": "voracode.ai/zen",
  "provider.connect.voracodeZen.visit.suffix": ", um Ihren API-SchlÃ¼ssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Voracode zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Voracode zu nutzen.",
  ...
  "dialog.plugins.empty": "In voracode.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Voracode-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingvoracode": "Voracode wird geprÃ¼ft...",
  "wsl.onboarding.checkingvoracodeIn": "Voracode in {{distro}} wird geprÃ¼ft...",
  "wsl.onboarding.updatingvoracode": "Voracode wird aktualisiert...",
  "wsl.onboarding.updatingvoracodeIn": "Voracode in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updatevoracodeIn": "Aktualisieren Sie Voracode in {{distro}}.",
  "wsl.onboarding.updatevoracode": "Voracode aktualisieren",
  "wsl.onboarding.voracodeReadyIn": "Voracode ist in {{distro}} bereit.",
  "wsl.onboarding.voracodeReady": "Voracode ist bereit.",
  "wsl.onboarding.installvoracodeIn": "Installieren Sie Voracode in {{distro}}.",
  "wsl.onboarding.installvoracode": "Voracode installieren",
  ...
  "wsl.onboarding.distroStatus.voracodeMissing": "Voracode nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Voracode einen WSL-Server hinzufÃ¼gen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfÃ¼gbar",
  "wsl.onboarding.wslUnavailable.description": "Voracode konnte WSL auf diesem Computer nicht Ã¼berprÃ¼fen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschlieÃŸen, und Ã¶ffnen Sie dann Voracode erneut.",
  ...
  "toast.update.description": "Eine neue Version von Voracode ({{version}}) ist zur Installation verfÃ¼gbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Voracode-Team",
  ...
  "error.chain.checkConfig": "ÃœberprÃ¼fen Sie Ihre Konfiguration (voracode.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Voracode unterstÃ¼tzt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Voracode enthÃ¤lt kostenlose Modelle, damit Sie sofort loslegen kÃ¶nnen.",
  ...
  "settings.desktop.wsl.description": "Voracode-Server innerhalb von WSL unter Windows ausfÃ¼hren.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache fÃ¼r Voracode Ã¤ndern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Voracode auf Ihrem GerÃ¤t aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "WÃ¤hlen Sie, ob Voracode dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Voracode anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Voracode automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Voracode.",
