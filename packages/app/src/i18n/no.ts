...
export const dict = {
  ...
  "dialog.provider.voracode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.voracode.tagline": "PÃ¥litelige, optimaliserte modeller",
  "dialog.provider.voracodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Voracode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nÃ¸kkel for Ã¥ koble til kontoen din og bruke {{provider}}-modeller i Voracode.",
  ...
  "provider.connect.voracodeZen.line1":
    "Voracode Zen gir deg tilgang til et utvalg av pÃ¥litelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.voracodeZen.visit.prefix": "BesÃ¸k ",
  "provider.connect.voracodeZen.visit.link": "voracode.ai/zen",
  "provider.connect.voracodeZen.visit.suffix": " for Ã¥ hente API-nÃ¸kkelen din.",
  "provider.connect.oauth.code.visit.prefix": "BesÃ¸k ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for Ã¥ hente autorisasjonskoden din for Ã¥ koble til kontoen din og bruke {{provider}}-modeller i Voracode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for Ã¥ koble til kontoen din og bruke {{provider}}-modeller i Voracode.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i voracode.json",
  ...
  "dialog.server.description": "Bytt hvilken Voracode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Voracode ({{version}}) er nÃ¥ tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Voracode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandÃ¸r-/modellnavnene i konfigurasjonen din (voracode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Voracode ikke stÃ¸tter MCP-autentisering ennÃ¥.',
  ...
  "sidebar.gettingStarted.line1": "Voracode inkluderer gratis modeller sÃ¥ du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "KjÃ¸r Voracode-serveren i WSL pÃ¥ Windows.",
  ...
  "settings.general.row.language.description": "Endre visningssprÃ¥ket for Voracode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Voracode ser ut pÃ¥ enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Voracode skal fÃ¸lge systemets, lyst eller mÃ¸rkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Voracode er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer nÃ¥r Voracode starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Voracode.",
  ...
  "wsl.onboarding.checkingvoracode": "Sjekker Voracode...",
  "wsl.onboarding.checkingvoracodeIn": "Sjekker Voracode i {{distro}}...",
  "wsl.onboarding.updatingvoracode": "Oppdaterer Voracode...",
  "wsl.onboarding.updatingvoracodeIn": "Oppdaterer Voracode i {{distro}}...",
  "wsl.onboarding.updatevoracodeIn": "Oppdater Voracode i {{distro}}.",
  "wsl.onboarding.updatevoracode": "Oppdater Voracode",
  ...
  "wsl.onboarding.distroStatus.voracodeMissing": "Voracode er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves fÃ¸r Voracode kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Voracode kunne ikke bekrefte WSL pÃ¥ denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows pÃ¥ nytt for Ã¥ fullfÃ¸re installasjonen av WSL, og Ã¥pne deretter Voracode pÃ¥ nytt.",
