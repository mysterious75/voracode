export const dict = {
  ...
  "dialog.provider.voracode.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.voracode.tagline": "Reliable optimized models",
  "dialog.provider.voracodeGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Voracode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Voracode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.voracodeZen.line1":
    "Voracode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.voracodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.voracodeZen.visit.prefix": "Visit ",
  "provider.connect.voracodeZen.visit.link": "voracode.ai/zen",
  "provider.connect.voracodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Voracode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Voracode.",
  ...
  "dialog.plugins.empty": "Plugins configured in voracode.json",
  ...
  "dialog.server.description": "Switch which Voracode server this app connects to.",
  ...
  "wsl.onboarding.checkingvoracode": "Checking Voracode...",
  "wsl.onboarding.checkingvoracodeIn": "Checking Voracode in {{distro}}...",
  "wsl.onboarding.updatingvoracode": "Updating Voracode...",
  "wsl.onboarding.updatingvoracodeIn": "Updating Voracode in {{distro}}...",
  "wsl.onboarding.updatevoracodeIn": "Update Voracode in {{distro}}.",
  "wsl.onboarding.updatevoracode": "Update Voracode",
  "wsl.onboarding.voracodeReadyIn": "Voracode is ready in {{distro}}.",
  "wsl.onboarding.voracodeReady": "Voracode is ready.",
  "wsl.onboarding.installvoracodeIn": "Install Voracode in {{distro}}.",
  "wsl.onboarding.installvoracode": "Install Voracode",
  ...
  "wsl.onboarding.distroStatus.voracodeMissing": "Voracode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Voracode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Voracode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Voracode.",
  ...
  "toast.update.description": "A new version of Voracode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Voracode team",
  ...
  "error.chain.checkConfig": "Check your config (voracode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Voracode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Voracode includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Voracode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Voracode",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Voracode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Voracode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Voracode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Voracode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Voracode.",
