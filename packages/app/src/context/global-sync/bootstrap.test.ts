...
import type { Config, voracodeClient, Project, Session } from "@voracode-ai/sdk/v2/client"
import type { NormalizedProviderListResponse } from "@voracode-ai/session-ui/context"
...
describe("query keys", () => {
  test("partitions identical directories by server scope", () => {
    const client = {} as voracodeClient
