...
beforeAll(async () => {
  ...
  mock.module("@voracode-ai/sdk/v2/client", () => ({
    createvoracodeClient: (input: { directory: string }) => {
      createdClients.push(input.directory)
      return clientFor(input.directory)
    },
  }))

  mock.module("@voracode-ai/ui/toast", () => ({
    Toast: { Region: () => null },
    showToast: () => 0,
  }))

  mock.module("@voracode-ai/core/util/encode", () => ({
