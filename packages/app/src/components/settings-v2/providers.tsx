...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "voracode", key: "dialog.provider.voracode.note" },
  { match: (id: string) => id === "voracode-go", key: "dialog.provider.voracodeGo.tagline" },
...
export const SettingsProvidersV2: Component<{ onBack?: () => void }> = (props) => {
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "voracode" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "voracode" || item.id === "voracode-go"}>
