...
beforeAll(async () => {
  ...
  mock.module("@voracode-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@voracode-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@voracode-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@voracode-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
