...
const GLOBAL_STORAGE = "voracode.global.dat"
const WINDOW_STORAGE = "voracode.window"
const LOCAL_PREFIX = "voracode."
...
function workspaceStorage(dir: string) {
  ...
  return `voracode.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `voracode.draft.${head}.${sum}.dat`
}
