...
import type { FileSearchHandle } from "@voracode-ai/session-ui/file"
import { useFileComponent } from "@voracode-ai/ui/context/file"
import { cloneSelectedLineRange, previewSelectedLines } from "@voracode-ai/session-ui/pierre/selection-bridge"
import { createLineCommentController } from "@voracode-ai/session-ui/line-comment-annotations"
import { createLineCommentControllerV2 } from "@voracode-ai/session-ui/v2/line-comment-annotations-v2"
import { sampledChecksum } from "@voracode-ai/core/util/encode"
import { DropdownMenu } from "@voracode-ai/ui/dropdown-menu"
import { IconButton } from "@voracode-ai/ui/icon-button"
import { LineCommentV2OverflowIcon } from "@voracode-ai/ui/v2/line-comment-v2"
  ...
  const renderFile = (source: string) => (
    <div class="relative overflow-hidden pb-40">
      <Dynamic
        ...
        search={search}
        class="select-text [--voracode-diffs-bg:var(--v2-background-bg-base)]"
        media={{
          mode: "auto",
          path: path(),
          current: state()?.content,
