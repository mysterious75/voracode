...
} from "@voracode-ai/session-ui/v2/session-review-v2"
import { SessionReviewFilePreviewV2 } from "@voracode-ai/session-ui/v2/session-review-file-preview-v2"
...
} from "@voracode-ai/session-ui/session-review"
...
export function ReviewPanelV2(props: ReviewPanelV2Props) {
  ...
  // Changes-only trees omit "M" â€” every row is already a change; A/D stay visible.
