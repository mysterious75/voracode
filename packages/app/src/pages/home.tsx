...
import { Logo } from "@voracode-ai/ui/logo"
import { Spinner } from "@voracode-ai/ui/spinner"
import { ScrollView } from "@voracode-ai/ui/scroll-view"
import { ProjectAvatar } from "@voracode-ai/ui/v2/project-avatar-v2"
...
import { base64Encode } from "@voracode-ai/core/util/encode"
...
import { Binary } from "@voracode-ai/core/util/binary"
import { ServerRowMenu } from "@/components/server/server-row-menu"
import { ServerHealthIndicator } from "@/components/server/server-row"
import { type ServerHealth } from "@/utils/server-health"
import { Persist, persisted } from "@/utils/persist"
import { useMarked } from "@voracode-ai/ui/context/marked"
import { preloadMarkdown } from "@voracode-ai/session-ui/markdown-cache"
    ...
    <div class="rounded-[10px] shadow-[var(--v2-elevation-raised)] m-2 min-h-0 lg:overflow-hidden bg-v2-background-bg-base self-stretch flex-1">
      <div class="mx-auto grid h-full w-full max-w-[1080px] grid-rows-[auto_minmax(0,1fr)_auto] gap-4 px-3 lg:grid-cols-[280px_minmax(0,720px)] lg:grid-rows-1 lg:gap-8 lg:px-6">
        <HomeProjectColumn
          ...
          openHelp={() => platform.openLink("https://voracode.ai/desktop-feedback")}
          language={language}
        />
