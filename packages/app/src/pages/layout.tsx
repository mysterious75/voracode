...
import { Session } from "@voracode-ai/sdk/v2/client"
...
import { toaster } from "@voracode-ai/ui/toast"
...
import { retry } from "@voracode-ai/core/util/retry"
...
import { useTheme, type ColorScheme } from "@voracode-ai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://voracode.ai/desktop-feedback")}
      renderPanel={() =>
