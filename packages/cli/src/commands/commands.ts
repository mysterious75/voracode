...
declare const VORACODE_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof VORACODE_CLI_NAME === "string" ? VORACODE_CLI_NAME : "voracode", {
  description: "Voracode 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
