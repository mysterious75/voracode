...
class Database extends Context.Service<Database, DatabaseShape>()("@voracode/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@voracode/example/UserStore") {
