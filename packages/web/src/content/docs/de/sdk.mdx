---
title: SDK
description: Typsicherer JS-Client fuer den voracode-Server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Das voracode JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und voracode programmatisch steuern.
...
Erstelle eine voracode-Instanz:
...
`voracode.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn voracode bereits laeuft, kannst du nur einen Client erstellen und verbinden:
