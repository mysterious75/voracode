---
title: Teilen
description: Teile Voracode-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Voracode-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Voracode Folgendes:
...
Voracode hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Voracode den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`voracode.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du voracode in deiner Organisation einsetzt.
