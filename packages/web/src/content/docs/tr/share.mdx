---
title: Paylasim
description: voracode konusmalarini genel baglantilarla paylasin.
---

voracode'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda voracode:
...
voracode, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak voracode manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `voracode.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda voracode kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
