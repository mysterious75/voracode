---
title: Dijeljenje
description: Dijelite Voracode razgovore javnim linkovima.
---

Voracode opcija dijeljenja vam omogucava da kreirate javne linkove za razgovore. Tako lakse saradujete s timom ili trazite pomoc od drugih.
...
Kada podijelite razgovor, Voracode:

1. Kreira jedinstveni javni URL za vasu sesiju
2. Sinhronizuje historiju razgovora na nase servere
3. Cini razgovor dostupnim preko linka za dijeljenje â€” `opncd.ai/s/<share-id>`

---

## Dijeljenje

Voracode podrzava tri nacina dijeljenja koji odreduju kako se razgovori dijele:

---

### RuÄno (zadano)

Po defaultu, Voracode koristi rucni nacin dijeljenja. Sesije se ne dijele automatski, ali ih mozete rucno podijeliti komandom `/share`:
...
Da ovo vazi za cijeli tim u odredenom projektu, dodajte postavku u projektni `voracode.json` i commitujte u Git.
...
[Saznajte vise](/docs/enterprise) o koristenju voracode u organizaciji.
