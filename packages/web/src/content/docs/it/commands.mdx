...
Crea `.voracode/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di Voracode o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Voracode:
...
- Globale: `~/.config/voracode/commands/`
- Per progetto: `.voracode/commands/`
...
voracode include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
