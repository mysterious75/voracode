...
import { Iconvoracode } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "voracode/session/message-v2"
import type { Message } from "voracode/session/message"
import type { Session } from "voracode/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.voracode_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.voracode_name}>
                    <Iconvoracode width={16} height={16} />
                  </div>
