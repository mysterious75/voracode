...
```
REGISTRY=ghcr.io/mysterious75 TAG=24.04 bun ./packages/containers/script/build.ts
REGISTRY=ghcr.io/mysterious75 TAG=24.04 bun ./packages/containers/script/build.ts --push
```
...
jobs:
  build-cli:
    ...
    container:
      image: ghcr.io/mysterious75/build/bun-node:24.04
```
