export const dict = {
  ...
  "desktop.updater.none.message": "VocÃª jÃ¡ estÃ¡ usando a versÃ£o mais recente do Voracode",
  ...
  "desktop.updater.downloaded.prompt":
    "A versÃ£o {{version}} do Voracode foi baixada. VocÃª gostaria de instalÃ¡-la e reiniciar?",
