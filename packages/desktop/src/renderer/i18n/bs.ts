export const dict = {
  ...
  "desktop.updater.none.message": "VeÄ‡ koristiÅ¡ najnoviju verziju Voracode-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Voracode-a je preuzeta. Å½eliÅ¡ li da je instaliraÅ¡ i ponovo pokreneÅ¡ aplikaciju?",
  ...
  "desktop.cli.installed.message":
    "CLI je instaliran u {{path}}\n\nRestartuj terminal da bi koristio komandu 'voracode'.",
