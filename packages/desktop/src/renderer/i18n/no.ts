export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Voracode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Voracode er lastet ned. Vil du installere den og starte p̴ nytt?",
  ...
  "desktop.cli.installed.message":
    "CLI installert til {{path}}\n\nStart terminalen p̴ nytt for ̴ bruke 'voracode'-kommandoen.",
