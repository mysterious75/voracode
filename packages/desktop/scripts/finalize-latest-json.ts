...
const releaseId = process.env.VORACODE_RELEASE
if (!releaseId) throw new Error("VORACODE_RELEASE is required")

const version = process.env.VORACODE_VERSION
if (!version) throw new Error("VORACODE_VERSION is required")
...
const macxTarGz = "voracode-desktop-mac-x64.app.tar.gz"
const macaTarGz = "voracode-desktop-mac-arm64.app.tar.gz"
