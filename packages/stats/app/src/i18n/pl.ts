export const dict = {
  "app.title": "Rankingi użycia modeli AI | Voracode Data",
  "app.description":
    "Przeglądaj użycie Voracode Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny Voracode Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę Voracode na GitHub",
  "header.github": "GitHub",
  "header.tryVoracode": "Wypróbuj Voracode",
  ...
  "footer.homeAria": "Strona główna Voracode",
  ...
  "home.topModelsDescription": "Użycie modeli w Voracode Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy Voracode Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | Voracode Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w Voracode Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia Voracode.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w Voracode",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia Voracode",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów Voracode z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | Voracode Data",
  "model.description":
    "Zobacz dane użycia {{model}} w Voracode Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie Voracode Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu Voracode Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu Voracode Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia Voracode Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny Voracode Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia Voracode Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów Voracode Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy Voracode Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji Voracode Go.",
  ...
  "model.geoDescription": "Tokeny modelu Voracode Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne Voracode Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów Voracode Go.",
