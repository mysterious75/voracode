export const dict = {
  "app.title": "Classements d'utilisation des modèles d'IA | Voracode Data",
  "app.description":
    "Explorez l'utilisation d'Voracode Go par modèle d'IA, avec le volume de tokens, les classements, la part de marché, le prix des tokens, le coût par session, le taux de cache et les répartitions géographiques.",
  "app.unfurlAlt": "Logo textuel Voracode Data sur un fond sombre à motif",
  ...
  "header.githubAria": "Ajouter une étoile à Voracode sur GitHub",
  "header.github": "GitHub",
  "header.tryVoracode": "Essayer Voracode",
  ...
  "footer.homeAria": "Accueil Voracode",
  ...
  "modal.title": "Newsletter Voracode",
  ...
  "home.topModelsDescription": "Utilisation des modèles dans Voracode Go.",
  ...
  "home.uniqueUsersDescription": "Utilisateurs uniques quotidiens d'Voracode Go par modèle.",
  ...
  "lab.title": "Utilisation et classements des modèles d'IA {{lab}} | Voracode Data",
  "lab.description":
    "Comparez les modèles {{lab}} utilisés dans Voracode Go, avec l'utilisation des tokens, les classements de modèles, les fenêtres de contexte, les dates de sortie, les coûts et les données propres aux modèles.",
  "lab.loadingTitle": "Laboratoire de modèles",
  "lab.loadingDescription": "Lecture de la disponibilité des modèles et de l'utilisation récente d'Voracode.",
  "lab.notFound": "Aucun modèle ne correspondait à ce laboratoire.",
  "lab.heroPrefix": "Explorez {{count}} modèles {{lab}} utilisés dans Voracode",
  ...
  "lab.shareOfUsage": "{{share}} de l'utilisation récente d'Voracode",
  "lab.usageTitle": "Utilisation des tokens {{lab}}",
  "lab.usageDescription": "Volume quotidien de tokens Voracode sur les deux derniers mois.",
  ...
  "lab.share": "Part",
  "model.title": "Utilisation, coût et rang de {{model}} | Voracode Data",
  "model.description":
    "Consultez les données d'utilisation Voracode Go de {{model}}, avec le volume de tokens, le rang hebdomadaire, la répartition des tokens, les coûts, le taux de cache, les sessions, les répartitions géographiques et les modèles proches.",
  ...
  "model.catalogFallback":
    "Faits du modèle issus de l'index partagé des modèles. L'utilisation Voracode Go apparaîtra dès que ce modèle aura de l'activité.",
  "model.unranked": "Non classé dans l'utilisation Voracode Go de la semaine dernière",
  "model.ranked": "Classé #{{rank}} dans l'utilisation Voracode Go de la semaine dernière",
  ...
  "model.noCurrentUsage": "Aucune utilisation Voracode Go dans la fenêtre de données actuelle.",
  ...
  "model.overviewDescription": "Tokens Voracode Go récents, utilisateurs uniques et position sur le marché.",
  "model.noSummaryTitle": "Aucun résumé d'utilisation",
  "model.noSummaryDescription": "Ce modèle n'a pas encore de lignes d'utilisation Voracode Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume quotidien de tokens Voracode Go sur la fenêtre récente de deux mois.",
  ...
  "model.usersDescription": "Utilisateurs uniques quotidiens d'Voracode Go sur la fenêtre récente de deux mois.",
  ...
  "model.efficiencyDescription": "Coût, comportement du cache et forme moyenne des sessions Voracode Go.",
  ...
  "model.geoDescription": "Tokens du modèle Voracode Go utilisés par pays.",
  "model.noGeoTitle": "Aucune donnée géographique",
  "model.noGeoDescription": "Aucune ligne géographique Voracode Go ne correspondait à ce modèle.",
  "model.worldMap": "Carte mondiale de l'utilisation des tokens du modèle par pays",
  "model.peersDescription": "Modèles proches par volume récent de tokens Voracode Go.",
