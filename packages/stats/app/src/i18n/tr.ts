export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | Voracode Data",
  "app.description":
    "Voracode Go kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde Voracode Data logosu",
  ...
  "header.githubAria": "GitHub'da Voracode'a yıldız ver",
  "header.github": "GitHub",
  "header.tryVoracode": "Voracode'u dene",
  ...
  "footer.homeAria": "Voracode ana sayfası",
  ...
  "home.topModelsDescription": "Voracode Go genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz Voracode Go kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | Voracode Data",
  "lab.description":
    "Voracode Go'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son Voracode kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "Voracode'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son Voracode kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük Voracode token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | Voracode Data",
  "model.description":
    "{{model}} için Voracode Go kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda Voracode Go kullanımı görünür.",
  "model.unranked": "Geçen haftaki Voracode Go kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki Voracode Go kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde Voracode Go kullanımı yok.",
  ...
  "model.overviewDescription": "Son Voracode Go tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz Voracode Go kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük Voracode Go token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz Voracode Go kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama Voracode Go oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan Voracode Go model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen Voracode Go coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son Voracode Go token hacmine göre yakındaki modeller.",
