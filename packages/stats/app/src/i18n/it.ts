export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | Voracode Data",
  "app.description":
    "Esplora l'utilizzo di Voracode Go nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo Voracode Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a Voracode su GitHub",
  "header.github": "GitHub",
  "header.tryVoracode": "Prova Voracode",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in Voracode Go.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di Voracode Go per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | Voracode Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in Voracode Go, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di Voracode.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in Voracode",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di Voracode",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token Voracode negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | Voracode Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in Voracode Go, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di Voracode Go appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo Voracode Go della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo Voracode Go della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di Voracode Go nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di Voracode Go, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di Voracode Go.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token Voracode Go nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di Voracode Go nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione Voracode Go.",
  ...
  "model.geoDescription": "Token del modello Voracode Go usati per paese.",
  "model.noGeoTitle": "Nessun dato geografico",
  "model.noGeoDescription": "Nessuna riga geografica Voracode Go corrispondeva a questo modello.",
  "model.worldMap": "Mappa mondiale dell'utilizzo dei token del modello per paese",
  "model.peersDescription": "Modelli vicini per volume recente di token Voracode Go.",
