...
const en = {
  "app.title": "AI Model Usage Rankings | Voracode Data",
  "app.description":
    "Explore Voracode Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "Voracode Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star Voracode on GitHub",
  "header.github": "GitHub",
  "header.tryVoracode": "Try Voracode",
  ...
  "home.topModelsDescription": "Usage of models across Voracode Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique Voracode Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | Voracode Data",
  "lab.description":
    "Compare {{lab}} models used in Voracode Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent Voracode usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in Voracode",
  ...
  "lab.shareOfUsage": "{{share}} of recent Voracode usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | Voracode Data",
  "model.description":
    "View {{model}} Voracode Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. Voracode Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's Voracode Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's Voracode Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No Voracode Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no Voracode Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "Voracode Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No Voracode Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent Voracode Go token volume.",
