import voracodeWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  href: "https://github.com/mysterious75/voracode",
  apiHref: "https://api.github.com/repos/mysterious75/voracode",
  fallbackStars: "150K",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "voracode:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://voracode.ai/">
            <strong>{i18n.t("header.tryVoracode")}</strong>
          </a>
          <button
...
function VoracodeMark() {
  return (
    <svg data-slot="voracode-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://voracode.ai/legal/terms-of-service", label: i18n.t("footer.terms") },
    { href: "https://voracode.ai/legal/privacy-policy", label: i18n.t("footer.privacy") },
  ]
  const connect = [
    { href: "mailto:hello@voracode.ai", label: i18n.t("footer.contact") },
    { href: "https://voracode.ai/discord", label: i18n.t("footer.community") },
    { href: "https://x.com/voracode", label: "X" },
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://voracode.ai" aria-label={i18n.t("footer.homeAria")}>
          <VoracodeMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={voracodeWordmarkDark} alt="Voracode" />
          <button
