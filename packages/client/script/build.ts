...
import { compile, emitEffectImported, emitPromise, write } from "@voracode-ai/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "VoracodeEventEncoded",
              import: 'import type { VoracodeEventEncoded } from "@voracode-ai/protocol/groups/event"',
            },
          },
        }),
