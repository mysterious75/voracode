...
Practical reference for the current tool-migration state in `packages/voracode`.
...
Tool tests should use the existing Effect helpers in `packages/voracode/test/lib/effect.ts`:
