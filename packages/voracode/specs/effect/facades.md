...
Concrete inventory of the remaining `makeRuntime(...)`-backed facades in `packages/voracode`.
...
- [x] `../core/src/filesystem.ts` (`FileSystem`) - legacy voracode service removed
