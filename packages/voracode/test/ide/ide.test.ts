...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders VORACODE_CALLER", () => {
    process.env["VORACODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode VORACODE_CALLER", () => {
    process.env["VORACODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown VORACODE_CALLER", () => {
    process.env["VORACODE_CALLER"] = "unknown"
