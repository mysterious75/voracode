...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips voracode-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-voracode-directory"]).toBeUndefined()
      expect(forwarded["x-voracode-workspace"]).toBeUndefined()
