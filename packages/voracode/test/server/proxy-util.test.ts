...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips voracode-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-voracode-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-voracode-directory")).toBeNull()
      expect(result.get("x-voracode-workspace")).toBeNull()
