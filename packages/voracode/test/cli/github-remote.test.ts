...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/voracode.git")).toEqual({ owner: "sst", repo: "voracode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/voracode")).toEqual({ owner: "sst", repo: "voracode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/voracode.git")).toEqual({ owner: "sst", repo: "voracode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/voracode")).toEqual({ owner: "sst", repo: "voracode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/voracode.git")).toEqual({ owner: "sst", repo: "voracode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/voracode")).toEqual({ owner: "sst", repo: "voracode" })
})
