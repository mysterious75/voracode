 ...
 *   "@voracode/ServerAuthConfig",
 *   {
 *     password: Config.string("VORACODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("VORACODE_SERVER_USERNAME").pipe(Config.withDefault("voracode")),
 *   },
 * ) {}
 *
