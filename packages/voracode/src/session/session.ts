...
import { Slug } from "@voracode-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@voracode-ai/llm"
...
import { locationServiceMapLayer } from "@voracode-ai/core/location-services"
...
import { PartTable, SessionTable } from "@voracode-ai/core/session/sql"
...
import { NonNegativeInt, optional } from "@voracode-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".voracode", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@voracode/Session") {}
