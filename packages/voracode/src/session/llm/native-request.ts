import type { JsonSchema, LLMRequest, ProviderMetadata } from "@voracode-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@voracode-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @voracode-ai/llm request objects from voracode's session/AI SDK-shaped data.
  return LLM.request({
