import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@voracode-ai/llm"
...
// Move this extraction into @voracode-ai/llm when Copilot is handled by the native runtime.
