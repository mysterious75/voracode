...
import { MAX_STEPS_PROMPT } from "@voracode-ai/core/session/runner/max-steps"
...
import { LLMEvent } from "@voracode-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@voracode/SessionPrompt") {}
