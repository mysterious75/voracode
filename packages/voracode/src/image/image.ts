...
export class Service extends Context.Service<Service, Interface>()("@voracode/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __VORACODE_PHOTON_WASM_PATH?: string }).__VORACODE_PHOTON_WASM_PATH =
