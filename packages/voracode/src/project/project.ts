...
import { ProjectDirectoryTable, ProjectTable } from "@voracode-ai/core/project/sql"
import { ProjectDirectories } from "@voracode-ai/core/project/directories"
...
import { which } from "@voracode-ai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@voracode/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.VORACODE_FAKE_VCS)
