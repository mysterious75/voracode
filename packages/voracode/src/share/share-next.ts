...
import type * as SDK from "@voracode-ai/sdk/v2"
...
import { SessionShareTable } from "@voracode-ai/core/share/sql"
...
const disabled = process.env["VORACODE_DISABLE_SHARE"] === "true" || process.env["VORACODE_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@voracode/ShareNext") {}
