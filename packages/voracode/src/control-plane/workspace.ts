...
import { EventSequenceTable, EventTable } from "@voracode-ai/core/event/sql"
...
import { WorkspaceEvent } from "@voracode-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@voracode/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        VORACODE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        VORACODE_WORKSPACE_ID: config.id,
        VORACODE_EXPERIMENTAL_WORKSPACES: "true",
