...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@voracode/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@voracode/ACPDirectory") {}
