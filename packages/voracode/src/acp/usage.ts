...
import type { AssistantMessage as VoracodeAssistantMessage, Message } from "@voracode-ai/sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@voracode-ai/core/effect/app-node"
...
export type AssistantTokenCost = Pick<VoracodeAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<VoracodeAssistantMessage, "role"> &
  Partial<Pick<VoracodeAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@voracode/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@voracode/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@voracode/ACPUsage") {}
