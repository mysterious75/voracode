...
//
// The saved variant persists across sessions in ~/.local/state/voracode/model.json
...
class Service extends Context.Service<Service, VariantService>()("@voracode/RunVariant") {}
