...
import { normalizePromptContent } from "@voracode-ai/tui/editor"
...
import { VORACODE_BASE_MODE, useBindings } from "@voracode-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Voracode" } satisfies SlashOption,
    ]
