...
import type { Event, GlobalEvent, voracodeClient } from "@voracode-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@voracode/RunStreamTransport") {}
