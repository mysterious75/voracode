...
import { openEditor } from "@voracode-ai/tui/editor"
import { registervoracodeKeymap } from "@voracode-ai/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registervoracodeKeymap(keymap, renderer, input.tuiConfig)
