import type { Hooks, PluginInput } from "@voracode-ai/plugin"
import type { Model } from "@voracode-ai/sdk/v2"
import { InstallationVersion } from "@voracode-ai/core/installation/version"
import { OauthCallbackPage } from "@voracode-ai/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. Voracode will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
