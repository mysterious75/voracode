...
import { AccountStateTable, AccountTable } from "@voracode-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@voracode/AccountRepo") {}
