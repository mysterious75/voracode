...
import { path } from "@voracode-ai/core/effect/app-node-platform"
...
import type { ProjectV2 } from "@voracode-ai/core/project"
...
import { WorktreeEvent } from "@voracode-ai/schema/worktree-event"
...
export class Service extends Context.Service<Service, Interface>()("@voracode/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `voracode/${name}`
