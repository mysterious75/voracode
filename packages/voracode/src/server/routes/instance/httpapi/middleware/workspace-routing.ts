...
>()("@voracode/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@voracode/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.VORACODE_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.VORACODE_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-voracode-directory"] || process.cwd()
}
