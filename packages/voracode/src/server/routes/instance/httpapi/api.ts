...
import { makeApi } from "@voracode-ai/protocol/api"
import { LocationMiddleware } from "@voracode-ai/server/location"
import { SessionLocationMiddleware } from "@voracode-ai/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("voracode-root")
...
export const InstanceHttpApi = HttpApi.make("voracode-instance")
...
export const VoracodeHttpApi = HttpApi.make("voracode")
